...
public class PublisherPageTest extends BaseTest {
    ...
    //Test Publisher page not existing and lead to search of them
    @Test(priority = 1)
    ...
    //Test if their game corresponding to them existed in search
    @Test(priority = 2)
    ...
    //Test Dynamic search box (Special feature)
    @Test(priority = 3)
